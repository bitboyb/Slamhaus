...
namespace Style
{
    ...
    bool IsColumnOpenLine(const std::string &line)
    {
        ...
        return trimmed.rfind(":column[", 0) == 0 || trimmed.rfind(":column[]", 0) == 0;
    }
    ...
    {
        std::string trimmed = Trim(line);
        return trimmed.rfind(":section[", 0) == 0 || trimmed.rfind(":section[]", 0) == 0;
    }
    ...
    {
        std::string trimmed = Trim(line);
        return trimmed.rfind(":css[", 0) == 0 || trimmed.rfind(":css[]", 0) == 0;
    }
